        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-lg text-blue-100/70 mb-12 leading-relaxed max-w-md">
              Streamline patient care, manage appointments, track inventory, 
              and handle billing — all in one powerful platform.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <motion.div
                  ...
                  className="p-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all cursor-pointer group"
                >
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <p className="text-blue-200/60 text-sm mt-1">Management Information System</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl shadow-black/20 overflow-hidden">
            <div className="p-8">
              <div className="text-center mb-8">
                <motion.div 
                  className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-indigo-500 mb-4 shadow-lg"
              ...
              <AnimatePresence>
                {error && (
                  <motion.div
                    ...
                    className="mb-6 p-4 bg-red-500/10 border border-red-500/20 rounded-xl text-sm text-red-300 text-center backdrop-blur-sm"
                  >
                    {error}
                  </motion.div>
                )}
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-blue-300/50 group-focus-within:text-blue-400 transition-colors" />
                    <Input
                      type="email"
                      placeholder="admin@hospital.com"
                      value={email}
                      onChange={(e) => setEmail(e.target.value)}
                      className="pl-11 h-12 rounded-xl bg-white/5 border-white/10 text-white placeholder:text-blue-300/30 focus:border-blue-500 focus:ring-blue-500/20 transition-all"
                      required
                      disabled={isLoading}
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <Lock className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-blue-300/50 group-focus-within:text-blue-400 transition-colors" />
                    <Input
                      type={showPassword ? "text" : "password"}
                      placeholder="Enter your password"
                      value={password}
                      onChange={(e) => setPassword(e.target.value)}
                      className="pl-11 pr-12 h-12 rounded-xl bg-white/5 border-white/10 text-white placeholder:text-blue-300/30 focus:border-blue-500 focus:ring-blue-500/20 transition-all"
                      required
                      disabled={isLoading}
                    />
                    <Button
                      ...
                      variant="ghost"
                      size="icon"
                      className="absolute right-2 top-1/2 -translate-y-1/2 h-8 w-8 text-blue-300/50 hover:text-white"
              ...
              <div className="mt-8 pt-6 border-t border-white/10">
                <p className="text-center text-xs text-blue-300/40">
                  Default: admin@hospital.com / Password@123
                </p>
              </div>
            </div>
          </div>
